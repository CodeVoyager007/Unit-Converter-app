...
export default function UnitConverterComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#f7bec0] text-[#c85250] relative">
      <div className="max-w-md w-full p-6 bg-[#e9eae0] rounded-lg shadow-lg border-2 border-[#e7625f] hover:shadow-2xl hover:scale-105 transition-transform duration-300 ease-in-out">
        <h1 className="text-3xl font-bold italic mb-1 text-center">
          𝓤𝓷𝓲𝓽 𝓒𝓸𝓷𝓿𝓮𝓻𝓽𝓮𝓻
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Button
            type="button"
            className="col-span-2 bg-[#e7625f] text-[#f7bec0] hover:bg-[#c85250] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
      ...
      {/* Tagline moved to the bottom right corner */}
      <p className="absolute bottom-4 right-4 text-sm italic">
        Made with <span className="text-[#800000]">♥</span> by Ayesha Mughal
      </p>
    </div>
  );
}
